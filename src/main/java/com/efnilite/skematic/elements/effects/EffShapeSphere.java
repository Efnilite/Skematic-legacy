...
@Patterns("(make|create) [a] [new] [(1¦hollow)] sphere at %location% (with|and) pattern %string% (with|and) radius %number%")
public class EffShapeSphere extends SkematicEffect {
    ...
    public String toString(Event e, boolean debug) {
        return "create sphere at " + expressions[0].toString(e, debug) + " with blocks " + expressions[1].toString(e, debug) + " with radius " + expressions[2].toString(e, debug);
    }
}
