...
public class ExprSelectionDimensions extends SimpleExpression<Number> {
    ...
    static {
        Skript.registerExpression(ExprSelectionDimensions.class, Number.class, ExpressionType.PROPERTY, "[the] (1¦length|2¦|height|3¦width) of (%player%'s selection|selection of %player%)");
    }
